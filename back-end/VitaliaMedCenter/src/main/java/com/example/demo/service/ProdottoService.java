...
public class ProdottoService {
	...
	//prende l'id come parametro d'ingresso e restituisce un oggetto che conterrà il prodotto (se trovato)
	...
	//metodo create che prende in ingresso un oggetto prodotto da inserire nel db gli setta l'id lo aggiunge alla lista
	// e lo restituisce
	...
	//metodo update prende in input id del prodotto da modificare e l'oggetto prodotto con i dati cerca il prodotto da modificare 
	...
	// metodo delete  ricerca il prodotto per id se non esiste restituiamo false altrimenti eliminiamo il prodotto
